...
@section('content')
    <div class="mb-6">
        ...
        <p class="text-gray-500 mt-1">Kemaskini maklumat jenis zakat.</p>
    </div>
    ...
    <div class="bg-white rounded-lg shadow p-6 max-w-xl">
        ...
        <form method="POST" action="{{ route('jenis-zakat.update', $jenis_zakat) }}">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" id="nama" name="nama" value="{{ old('nama', $jenis_zakat->nama) }}"
                ...
                <div>
                    ...
                    <input type="number" id="kadar" name="kadar" value="{{ old('kadar', $jenis_zakat->kadar) }}" step="0.0001" min="0"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500" required>
                </div>
                ...
                <div>
                    ...
                    <textarea id="penerangan" name="penerangan" rows="3"
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500">{{ old('penerangan', $jenis_zakat->penerangan) }}</textarea>
                </div>

                <div class="flex items-center">
                    <input type="hidden" name="is_aktif" value="0">
                    <input type="checkbox" id="is_aktif" name="is_aktif" value="1" {{ old('is_aktif', $jenis_zakat->is_aktif) ? 'checked' : '' }}
