...
@section('content')
    <div class="mb-6">
        ...
        <p class="text-gray-500 mt-1">Kemaskini maklumat pembayaran zakat.</p>
    </div>
        ...
        <form method="POST" action="{{ route('pembayaran.update', $pembayaran) }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="number" id="jumlah" name="jumlah" value="{{ old('jumlah', $pembayaran->jumlah) }}" step="0.01" min="0.01"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500" required>
                </div>
                ...
                <div>
                    ...
                    <input type="date" id="tarikh_bayar" name="tarikh_bayar" value="{{ old('tarikh_bayar', $pembayaran->tarikh_bayar->format('Y-m-d')) }}"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500" required>
                </div>
                ...
                <div>
                    ...
                    <input type="text" id="no_resit" name="no_resit" value="{{ old('no_resit', $pembayaran->no_resit) }}"
